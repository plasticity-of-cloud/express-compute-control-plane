        ...
        if (deployTenantService) {
            ...
            tenantFn = Function.Builder.create(this, "EcpTenantFunction")
                ...
                .environment(java.util.Map.ofEntries(
                    Map.entry("ECP_TENANTS_TABLE", tenantsTable.getTableName()),
                    Map.entry("ECP_CLUSTERS_TABLE", clustersTable.getTableName()),
                    Map.entry("ECP_LT_ARM64_ONDEMAND", ltArm64Ondemand),
                    Map.entry("ECP_LT_ARM64_SPOT", ltArm64Spot),
                    Map.entry("ECP_LT_X86_ONDEMAND", ltX86Ondemand),
                    Map.entry("ECP_LT_X86_SPOT", ltX86Spot),
                    Map.entry("ECP_VPC_ID", vpcId),
                    Map.entry("ECP_KMS_CA_KEY_ID", caSigningKey.getKeyId()),
                    Map.entry("ECP_AVAILABILITY_ZONE", "auto"),
                    Map.entry("ECP_DRY_RUN", String.valueOf(dryRun)),
                    Map.entry("ECP_DEPLOYMENT_MODE", effectiveDeploymentMode),
                    Map.entry("ECP_MAX_TENANTS_PER_CALLER", maxTenantsPerCaller.getStringValue()),
