...
public class TenantProvisioningService {
    ...
    @ConfigProperty(name = "express-compute.tenant.availability-zone", defaultValue = "")
    ...
    public void deprovision(String tenantId) {
        ...
        // 2. Remove cluster registration from ecp-clusters table
    ...
    public String registerSelfManagedCluster(String clusterName, String issuer, String jwks, String ownerArn,
        ...
        // Optional: cluster type for provider routing (defaults to MANAGED if absent)
