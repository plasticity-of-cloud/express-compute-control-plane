    ...
    private String tenantInlinePolicy(String tenantId, String clusterName, String region, String accountId) {
        return """
              ...
              "Statement": [
                {
                  ...
                  "Resource": "arn:aws:secretsmanager:%s:%s:secret:ecp/tenant/%s/*"
                },
                {
                  "Sid": "EcpApiInvoke",
                  "Effect": "Allow",
                  ...
                  "Resource": [
                    ...
                    "arn:aws:execute-api:%s:%s:*/*/GET/clusters/%s/workload-identities",
                    "arn:aws:execute-api:%s:%s:*/*/POST/clusters/%s/workload-identities",
                    "arn:aws:execute-api:%s:%s:*/*/DELETE/clusters/%s/workload-identities/*"
                  ]
                },
                {
                ...
                },
                {
                  ...
                  "Effect": "Allow",
                  "Action": "iam:PassRole",
                  "Resource": "arn:aws:iam::%s:role/ecp-tenant-%s-ir",
            ...
            """.formatted(
                ...
                region, accountId,                 // EcpApiInvoke GET /clusters
                region, accountId,                 // EcpApiInvoke POST /clusters
                region, accountId, clusterName,    // EcpApiInvoke GET /clusters/{name}
                region, accountId, clusterName,    // EcpApiInvoke POST /clusters/{name}
                region, accountId, clusterName,    // EcpApiInvoke DELETE /clusters/{name}
                region, accountId, clusterName,    // EcpApiInvoke GET /clusters/{name}/workload-identities
                region, accountId, clusterName,    // EcpApiInvoke POST /clusters/{name}/workload-identities
                region, accountId, clusterName,    // EcpApiInvoke DELETE /clusters/{name}/workload-identities/*
