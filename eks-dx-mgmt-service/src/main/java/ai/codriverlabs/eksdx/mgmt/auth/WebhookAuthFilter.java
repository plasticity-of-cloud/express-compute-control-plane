package ai.codriverlabs.eksdx.mgmt.auth;

import ai.codriverlabs.eksdx.mgmt.service.JwksTokenValidationService;
...
/**
 * Validates webhook SA tokens on GET pod-identity-associations endpoints.
...
public class WebhookAuthFilter implements ContainerRequestFilter {
    ...
    public void filter(ContainerRequestContext ctx) {
        ...
        if (!path.contains("/pod-identity-associations") || !"GET".equals(ctx.getMethod())) return;
